...
var contact1 = {
    ...
    var numberToCall = contact1.number.find(function (val) {
      // return val.isPrimary === true;   //for other data types we have to use like ths.
        return val.isPrimary;   //when we have to return boolean value we can write like this.
    });
    if (numberToCall !== undefined) {
        console.log("Calling " + numberToCall.value);
    } else {
